...
class ProductListingScreen extends StatefulWidget {
  ...
  static final String routeName = '/product-listing';
                ...
                child: Column(
                  ...
                  children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(4),
                                        border: Border.all(color: Color(0XFFF2F2F2))),
                                    child: i==0?Image.asset('assets/images/demo/f${2}.png'):Container(),
                                  ),
                                  if(i==0)Positioned(
                                    right: 0,
                                    top: -4,
                    ...
                    Padding(
                      ...
                      child: AppFilledButton(
                        onPressed: () {
                          Navigator.of(context).pushNamed(CompareProductsScreen.routeName);
                        },
                        title: 'Compare',
                      ),
                    ),
