...
class CelebrityProductListingScreen extends StatefulWidget {
  const CelebrityProductListingScreen({Key? key}) : super(key: key);
  static final String routeName = '/celebrity-product-listing';

  @override
  _CelebrityProductListingScreenState createState() =>
      _CelebrityProductListingScreenState();
}

class _CelebrityProductListingScreenState
    extends State<CelebrityProductListingScreen> {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Stack(
              children: [
                SizedBox(height:215.0.toScreenHeight(context),child: Image.asset('assets/images/demo/celebrity.jpg', fit: BoxFit.fitHeight,)),
                Row(
                  children: [
                    IconButton(
                      icon: Icon(
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.of(context)
                          .pushNamed(ProductListingSecondScreen.routeName);
                    },
                    child: Text(
                      '12,000 results',
                      style: TextStyle(
